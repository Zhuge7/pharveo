...
// 🔧 REMPLACER par ton vrai numéro WhatsApp (format international, sans +)
const WHATSAPP_NUMBER = "18199957827";
const WHATSAPP_MESSAGE = encodeURIComponent(
  "Bonjour, je souhaite en savoir plus sur Pharveo pour ma force de vente pharmaceutique."
);
